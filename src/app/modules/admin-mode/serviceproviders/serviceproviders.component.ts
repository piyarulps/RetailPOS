...
export class ServiceprovidersComponent implements OnInit {
	...
	moduleName: string = 'ServiceProvider';
	displayModuleName: string = 'Service Provider';
	moduleAPI: string = 'vendorlist/?partyrole=Vendor&vendortype=ServiceProvider&';
	moduleFilterAPI: string = 'itemapis/filters/';
	moduleLink: string = 'admin-mode/serviceproviders';
	...
	syncData() {
		this._helper.apiGetLocal('serviceprovidersync/').subscribe(
			res => { },
			error => {
				console.log('error', error);
