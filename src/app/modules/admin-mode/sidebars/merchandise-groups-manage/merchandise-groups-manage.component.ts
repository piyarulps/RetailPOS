...
@Component({
	selector: 'app-merchandise-groups-manage',
	templateUrl: './merchandise-groups-manage.component.html',
	styleUrls: ['./merchandise-groups-manage.component.scss']
})
export class MerchandiseGroupsManageComponent implements OnInit {
